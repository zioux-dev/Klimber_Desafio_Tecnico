...
namespace DevelopmentChallenge.Data.Tests
{
    ...
    {
        #region Old Test FormaGeometrica
        [TestCase]
        ...
        [TestCase]
        public void TestResumenListaVaciaNew()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometricaNew.Imprimir(new List<FormaGeometricaNew>(), 1));
        }

        [TestCase]
        public void TestResumenListaVaciaFormasEnInglesNew()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>",
                FormaGeometricaNew.Imprimir(new List<FormaGeometricaNew>(), 2));
        }

        [TestCase]
        public void TestResumenListaConUnCuadradoNew()
        {
            var cuadrados = new List<FormaGeometricaNew> { new Cuadrado(5) };

            var resumen = FormaGeometricaNew.Imprimir(cuadrados, (int)FormaGeometricaNew.Idiomas.Castellano);
        ...
        [TestCase]
        public void TestResumenListaConMasCuadradosNew()
        {
            var cuadrados = new List<FormaGeometricaNew>
            {
                new Cuadrado(5),
                new Cuadrado(1),
                new Cuadrado(3)
            ...
            var resumen = FormaGeometricaNew.Imprimir(cuadrados, (int)FormaGeometricaNew.Idiomas.Ingles);

            Assert.AreEqual("<h1>Shapes report</h1>3 Squares | Area 35 | Perimeter 36 <br/>TOTAL:<br/>3 shapes Perimeter 36 Area 35", resumen);
        }

        [TestCase]
        public void TestResumenListaConMasTiposNew()
        {
            ...
            var resumen = FormaGeometricaNew.Imprimir(formas, (int)FormaGeometricaNew.Idiomas.Ingles);
        ...
        [TestCase]
        public void TestResumenListaConMasTiposEnCastellanoNew()
        {
            var formas = new List<FormaGeometricaNew>
            {
                new Cuadrado(5),
            ...
            var resumen = FormaGeometricaNew.Imprimir(formas, (int)FormaGeometricaNew.Idiomas.Castellano);
        ...
        public void TestRandomNew()
        {
            ...
            var resumen = FormaGeometricaNew.Imprimir(cuadrados, (int)FormaGeometricaNew.Idiomas.Italiano);

            Assert.AreEqual("<h1>Rapporto delle Forme</h1>1 Cuadrado | Area 25 | Perimetrazione 20 <br/>1 Triangulo | Area ,43 | Perimetrazione 3 <br/>1 Circulo | Area 3,14 | Perimetrazione 6,28 <br/>TOTAL:<br/>3 forme Perimetro 29,28 Area 28,57", resumen);
        }
